...
import { Container, Row, Col, Card, CardHeader, ListGroup, ListGroupItem, Form, Alert } from "shards-react";
  ...
  <div>
    <Container fluid className="px-0">
      <Alert className="mb-0 bg-danger">
        <i className="fa fa-laptop mx-2"></i> How you doin'? I'm just a friendly, good-looking notification message and
        I come in all the colors you can see below. Pretty cool, huh?
      </Alert>
    </Container>
